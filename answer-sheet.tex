...
%%%%%%%%%%%%%%% MEMBUAT HEADER %%%%%%%%%%%%%%%%%%
\header{\bfseries Filsafat Ilmu\\Lorem Ipsum}{}{\bfseries Ujian Akhir Semester\\ 
\today} % membuat header
\headrule % membuat garis di header
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

%%%%%%%%%%%%%%% MEMBUAT FOOTER %%%%%%%%%%%%%%%%%%
\footer{\bfseries Lorem Ipsum Dolor}{\bfseries Halaman \thepage\ dari \numpages}{\bfseries 
...
\newcommand{\nama}{Lorem Ipsum Dolor Sit Amet}       %%%%%%%%%%%  MASUKKAN NAMA
\newcommand{\NIM}{12345678901233}                 %%%%%%%%%%%  MASUKKAN NOMOR INDUK MAHASISWA
\newcommand{\prodi}{Lorem Ipsum / B}  %%%%%%%%%%%  MASUKKAN NAMA PRODI DAN KELAS
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{document}
	...
	\begin{questions}
		\input{soal/soal-pertama}
		
		\input{soal/soal-kedua}
		
		\input{soal/soal-ketiga}
		
		\input{soal/soal-keempat}
		
		\input{soal/soal-kelima}
